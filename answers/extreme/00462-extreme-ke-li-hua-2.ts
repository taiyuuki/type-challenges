...
type ArgumentTypes<A extends any[], R extends any[] = A> =
  A extends [...infer Rest, any]
    ? Rest['length'] extends 0
      ? R
      : ArgumentTypes<Rest, R | Rest>
    : R

type Slice<T extends any[], N extends number, R extends any[] = []> =
  R['length'] extends N
    ? T
...
type Curry<Args extends any[], R> =
  <P extends ArgumentTypes<Args>>(...args: P) => P extends Args
    ? R
    : Curry<Slice<Args, P['length']>, R>
