...
type Curry<Args extends any[], R> = Args extends [infer First, ...infer Rest]
  ? (arg: First) => Args['length'] extends 1
      ? R
      : Curry<Rest, R>
  : () => R
...
declare function Currying<
 F extends Function,
>(fn: F): F extends (...args: infer Args) => infer R ? Curry<Args, R> : never
