...
type NTT<N, T extends unknown[] = []> = T['length'] extends N ? T : NTT<N, [...T, 1]>

type Sub<A, B, C extends unknown[] = NTT<A>> = C extends [...NTT<B>, ...infer D] ? D['length'] : -1
